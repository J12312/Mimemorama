    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Ayuda",
                html: `
                       1.-Todas las cartas estan colocada boca abajo, de manera que las imagenes no se vean.<br>
                       2.-En este juego las cartas estan puestas en filas y columnas. <br>
                       3.- Tienes que reconstruir los pares de cartas girandolas de 2 en 2.<br> 
                       4.-Si las cartas son las mismas (un par), ganas y el par se bloquea.<br
                       5.-De lo contrario, las cartas se colocan automaticamente boca abajo y debes hacer un nuevo intento.<br>
                       6.-Encuentra todas las pares en en el menor numero de clics posible.
                `,
